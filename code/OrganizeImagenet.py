...
root_dir = "/home/cnslab/imagenet_blur/gaussian/"

for i in range(len(blurLevels)): # different levels of blurring
    mult = blurLevels[i]
    print("Working with square kernel dimension = " + str(mult))
    for directory, subdirectories, files in os.walk(root_dir + 'imagenet_' + str(mult)):
            ...
            for file in files:
                if file.lower().endswith('.jpeg') or file.lower().endswith('.jpg') or file.lower().endswith('.png'):
                    ...
                    if train == 1:
                        ...
                        os.system("scp " + name + ' /home/cnslab/imagenet_blur24/gaussian/imagenet_' + str(mult) + '/train/' + endPath + '/' + file)
                        train *= -1
                    else:
                        ...
                        os.system("scp " + name + ' /home/cnslab/imagenet_blur24/gaussian/imagenet_' + str(mult) + '/val/' + endPath + '/' + file)
                        train *= -1
